            ...
            <nav className="space-y-8">
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Link href={route('customer.projects')} className="flex items-center space-x-3 text-white/60 hover:text-white p-2 rounded-lg hover:bg-white/10 transition-colors group">
                            <svg className="w-5 h-5 group-hover:text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
